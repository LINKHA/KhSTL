...
struct KH_STL_API ListNodeBase
{
    /// Construct.
    ListNodeBase() :
        _prev(nullptr),
...
struct KH_STL_API ListIteratorBase
{
    /// Construct.
    ListIteratorBase() :
        _ptr(nullptr)
...
public:
    ...
    {
        KhSTL::Swap(_ptrs, list._ptrs);
        KhSTL::Swap(_allocator, list._allocator);
    }
