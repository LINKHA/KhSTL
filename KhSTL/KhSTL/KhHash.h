...
///
///
template<typename _Value> using HashSet = KhSTL::Detail::tHashSet<_Value>;
///
///
///
template<typename _Key, typename _Value> using HashMap = KhSTL::Detail::tHashMap<_Key, _Value>;
}
